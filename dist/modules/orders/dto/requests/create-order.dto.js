...
__decorate([
    ...
    (0, class_validator_1.Min)(1, { message: 'Product ID must be greater than 0' }),
...
__decorate([
    ...
    (0, class_validator_1.Min)(0, { message: 'Unit price must be non-negative' }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_transformer_2.Transform)(({ value }) => parseFloat(value)),
    __metadata("design:type", Number)
...
__decorate([
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(1, { message: 'Customer ID must be greater than 0' }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_transformer_2.Transform)(({ value }) => parseInt(value)),
    __metadata("design:type", Number)
